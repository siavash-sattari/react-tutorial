              ...
              <div className='article'>
                ...
                <div className='article__header'>
                  ...
                  <div className='article-header__category article-header__item'>
                    ...
                    <span className='article-header__text'> ارسال شده توسط ایمان</span>
                  </div>
                  <div className='article-header__category article-header__item'>
                ...
                <img src='/images/blog/4.png' alt='Article Cover' className='article__banner' />
                ...
                <p className='article__paragraph paragraph'>
                  جاوا اسکریپت یکی از زبان‌های برنامه‌نویسی اصلی حوزه فرانت‌اند است که به واسطه فریم ورک‌های آن می‌توان انواع وب سایت‌ها، اپلیکیشن‌ها
                  و وب اپلیکیشن‌ها را طراحی کرد. به طور کلی بعد از یادگیری html و css معمولاً باید آموزش جاوا اسکریپت را نیز فرا بگیرید. . چرا که این
                  زبان تکمیل‌کننده html و css بوده و در چنین شرایطی موقعیت‌های شغلی بیشتر را در اختیار خواهید داشت و همچنین می‌توانید پروژه‌های
                  گسترده‌تری را انجام دهید. در حال حاضر با وجود منابع رایگان موجود در وب شما به راحتی می‌توانید زبان جاوا اسکریپت را به صورت حرفه‌ای
                  فرا بگیرید. به همین واسطه در ادامه مطلب قصد داریم سایت‌های شاخص آموزش این زبان برنامه‌نویسی در جهان را به شما معرفی کنیم و در آخر
                  بگوییم که بهترین سایت آموزش جاوا اسکریپت کدام است.
                </p>
                ...
                <div className='article-read'>
                  ...
                  <ul className='article-read__list'>
                    ...
                    <li className='article-read__item'>
                      <a href='#' className='article-read__link'>
                        یک راه آسان‌تر، دوره‌ های جاوا اسکریپت آکادمی گرین لرن!
                      </a>
                    </li>
                    <li className='article-read__item'>
                      <a href='#' className='article-read__link'>
                        ثبت نام در دوره‌ های جاوا اسکریپت گرین لرن:
                      </a>
                    </li>
                  </ul>
                </div>

                <img src='/images/blog/4.png' alt='Article Image' className='article__seconadary-banner' />
                <div className='article-section'>
                  ...
                  <p className='paragraph article-section__text'>
                    توجه داشته باشید که تمام وب سایت‌هایی که به عنوان بهترین سایت آموزش جاوا اسکریپت در ادامه معرفی می‌کنیم، بین‌المللی هستند و منابع
                    موجود در آن‌ها به زبان انگلیسی است. در نتیجه شما باید یا تسلط متوسط و حداقلی به زبان انگلیسی داشته باشید و یا اینکه با استفاده از
                    گوگل ترنسلیت منابع موجود را ترجمه کرده و از آن‌ها استفاده کنید. به همین دلیل در انتهای محتوا به شما خواهیم گفت که راه آسان دیگری
                    برای یادگیری زبان جاوا اسکریپت وجود دارد که شما بتوانید به واسطه آن به صورت رایگان و به زبان فارسی این زبان را یاد بگیرید.
                  </p>

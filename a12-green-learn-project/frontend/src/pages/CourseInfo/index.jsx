            ...
            <div class='col-8'>
              <div class='course'>
                <div class='course-boxes'>
                  <div class='row'>
                    <CourseDetailBox icon='fas fa-graduation-cap' title='وضعیت دوره:' text='به اتمام رسیده' />
                    <CourseDetailBox icon='fas fa-clock' title=' مدت زمان دوره:' text='19 ساعت' />
                    <CourseDetailBox icon='fas fa-calendar-alt' title='آخرین بروزرسانی:' text='1401/03/02' />
                    <CourseDetailBox icon='fa fa-user-large' title='روش پشتیبانی' text='آنلاین' />
                    <CourseDetailBox icon='fa fa-circle-info' title='پیش نیاز:' text='HTML CSS' />
                    <CourseDetailBox icon='fa fa-play' title='نوع مشاهده:' text='ضبط شده / آنلاین' />
                  </div>
                </div>
                ...
                <div class='introduction'>
                  <div class='introduction__item'>
                    <span class='introduction__title title'>آموزش 20 کتابخانه جاوا اسکریپت مخصوص بازار کار</span>
                    <img src='/images/info/1.gif' alt='course info image' class='introduction__img img-fluid' />
                    <p class='introduction__text'>
                      کتابخانه های بسیار زیادی برای زبان جاوا اسکریپت وجود دارد و سالانه چندین کتابخانه جدید نیز به این لیست اضافه می شود که در بازار
                      کار به شدت از آن ها استفاده می شود و اگر بدون بلد بودن این کتابخانه ها وارد بازار کار شوید، خیلی اذیت خواهید شد و حتی ممکن است
                      ناامید شوید!
                    </p>
                    <p class='introduction__text'>
                      در این دوره نحوه کار با 20 مورد از پر استفاده ترین کتابخانه های جاوا اسکریپت به صورت پروژه محور به شما عزیزان آموزش داده می شود
                      تا هیچ مشکلی برای ورود به بازار کار نداشته باشید
                    </p>
                  </div>
                  <div class='introduction__item'>
                    <span class='introduction__title title'>هدف از این دوره چیست؟ (تنها راه ورود به بازار کار و کسب درآمد)</span>
                    <img src='/images/info/2.jpg' alt='course info image' class='introduction__img img-fluid' />
                    <p class='introduction__text'>
                      وقتی برای اولین بار وارد یکی از شرکت های برنامه نویسی شدم، از کتابخانه هایی به اسم Lodash و Formik استفاده می شد، در حالی که من
                      اولین بارم بود اسم Formik را می شنیدم و تا اون موقع از این کتابخانه ها استفاده نکرده بودم.
                    </p>
                    <p class='introduction__text'>
                      همینجا بود که متوجه شدم کتابخانه های جاوا اسکریپت یکی از مهم ترین مباحثی هستند که هر برنامه نویس وب برای ورود به بازار کار و کسب
                      درآمد بهتر، راحت و بیشتر باید با آن ها کار کرده باشد{' '}
                    </p>
                    <p class='introduction__text'>
                      همان طور که از اسم این دوره مشخص است، هدف از این دوره آموزش 20 مورد از کاربردی ترین و پر استفاده ترین کتابخانه های جاوا اسکریپت
                      است تا شما بتوانید بعد از این دوره با قدرت و آمادگی بیشتر ادامه مسیر برنامه نویسی وب را ادامه دهید، ری اکت یا نود یا … را راحت
                      تر یاد بگیرید و در نهایت وارد بازار کار شده و کسب درآمد کنید.
                    </p>
                    <p class='introduction__text'>
                      شا به عنوان یک برنامه نویس وب، حداقل اگر با کتابخانه خاصی کار نکرده باشید، باید بلد باشید که چطور باید یک کتابخانه جدید را یاد
                      بگیرید. فرض کنید یک یک کتابخانه جدید ساخته شد. آیا شما باید منتظر دوره آموزشی باشید؟! قطعا نه.
                    </p>
                    <p class='introduction__text'>
                      در این دوره سعی کردیم علاوه بر آموزش مستقیم هر کتابخانه، نحوه یادگیری یک کتابخانه جدید را نیز به شما عزیزان آموزش دهیم تا بعد از
                      گذراندن دوره، دیگر وابسته هیچ دوره یا شخص خاصی نباشید و اگر کتابخانه جدیدی به دنیای جاوا اسکریپت و وب اضافه شد، به راحتی بتوانید
                      آن را یاد بگیرید.
                    </p>
                  </div>
                  ...
                  <div class='techer-details'>
                    <div class='techer-details__header'>
                      <div class='techer-details__header-right'>
                        <img src='/images/info/teacher.jpg' alt='Teacher Profile' class='techer-details__header-img' />
                        <div class='techer-details__header-titles'>
                          <a href='#' class='techer-details__header-link'>
                            سیاوش ستاری
                          </a>
                          <span class='techer-details__header-skill'>Front End & Back End Developer</span>
                        </div>
                      </div>
                    ...
                    <p class='techer-details__footer'>
                      اول از همه برنامه نویسی اندروید رو شروع کردم و نزدیک به 2 سال با زبان جاوا اندروید کار میکردم .بعد تصمیم گرفتم در زمینه وب
                      فعالیت داشته باشم.و..
                    </p>
                  </div>
            ...
            <div class='col-4'>
              <div class='courses-info'>
                ...
                <div class='course-info'>
                  ...
                  <span class='course-info__short-url'>https://greenlearn.com/?p=117472</span>
                </div>
                <div class='course-info'>
                  ...
                  <ul class='course-info__courses-list'>
                    <li class='course-info__courses-list-item'>
                      <a href='#' class='course-info__courses-link'>
                        ...
                        <span class='course-info__courses-text'>پروژه های تخصصی با جاوا اسکریپت</span>
                      </a>
                    </li>
                    <li class='course-info__courses-list-item'>
                      <a href='#' class='course-info__courses-link'>
                        <img src='/images/courses/fareelancer.png' alt='Course Cover' class='course-info__courses-img' />
                        <span class='course-info__courses-text'>تعیین قیمت پروژه های فریلنسری</span>
                      </a>
                    </li>
                    <li class='course-info__courses-list-item'>
                      <a href='#' class='course-info__courses-link'>
